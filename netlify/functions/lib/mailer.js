...
async function sendCodeEmail(to, code, purpose) {
  ...
  const heading = isReset ? 'Код для відновлення паролю' : 'Код підтвердження реєстрації';
  const html = `
    <div style="font-family:sans-serif;max-width:420px;margin:0 auto;padding:24px">
      ...
      <p style="color:#666;font-size:13px;margin-top:16px">Код дійсний 15 хвилин. Якщо це був не ти — просто проігноруй цей лист, нічого не станеться.</p>
    </div>`;
